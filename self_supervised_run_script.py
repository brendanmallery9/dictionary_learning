...
semi_supervised_plot_atoms_indata(filename, model, 1000, dim,True,just_save=True)
semi_supervised_plot_all_indata(filename, model, 1000, dim,True,just_save=True)
